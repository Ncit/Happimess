...
public class BTNavigationDropdownMenu: UIView {
    ...
    public var didShow: ((indexPath: Int) -> ())?
    public var didHide: ((indexPath: Int) -> ())?
    public var selectItem: ((indexPath: Int) -> ())?
    ...
    public init(title: String, items: [AnyObject]) {
        ...
        // Set frame
        let frame = CGRectMake(0, 0, 135, 30)
        ...
        self.menuTitle.textColor = UIColor.whiteColor()//self.menuTitleColor
        ...
        self.backgroundView = UIButton(frame: menuWrapperBounds)
        self.backgroundView.backgroundColor = UIColor.blackColor()
        self.backgroundView.alpha = 0.6
//        self.configuration.maskBackgroundColor
        self.backgroundView.autoresizingMask = UIViewAutoresizing.FlexibleWidth.union(UIViewAutoresizing.FlexibleHeight)
        self.backgroundView.enabled = true

        self.backgroundView.titleLabel?.text = "adlfnlajndflnj adlnjf ajlndfljn aldjnf lajndfl jandflj nadljn adljgn aldjng lajdngl jadngljna dlgjnaldj nglajndg ljnadglj nadljgn aljdng ljandgljn aldjgnladj nglajdngl jnadglj naldjgn lajdng ljandgl jnadlgjn aldjgn aldjng lajdng ljandgl jnadlgjn ladjng ljandg ljnadgl jnadljgn lajdng lajndglj nadljgn aldjng ljandgl jnadlgjn ladjng lajndg ljnadlgj nkjbg khbsafg bhkafg bagsbhags bhag klbhafg bhlafg bhlag bhag bhafg bhlag fbh"
       self.backgroundView.addTarget(self, action: "hideMenu:", forControlEvents: UIControlEvents.TouchUpInside)
        // Init table view
...
//            self.setMenuTitle("\(items[indexPath])")
    ...
    func setupDefaultConfiguration() {
        ...
        self.cellBackgroundColor = UIColor(red: CGFloat(234/255.0), green: CGFloat(62/255.0), blue: CGFloat(104/255.0), alpha: 1.0)
    ...
    func showMenu() {
        self.menuWrapper.frame.origin.y = 64//self.navigationController!.navigationBar.frame.maxY
        self.didShow!(indexPath: 0)
        // Table view header
        let headerView = UIView(frame: CGRectMake(0, 0, self.frame.width, 300))
        headerView.backgroundColor = UIColor(red: CGFloat(234/255.0), green: CGFloat(62/255.0), blue: CGFloat(104/255.0), alpha: 1.0)
        ...
        UIView.animateWithDuration(
            ...
            animations: {
                ...
                self.backgroundView.alpha = 0.6//self.configuration.maskBackgroundOpacity
            }, completion: nil
        )
...
//    var maskBackgroundOpacity: CGFloat!
    ...
    func defaultValue() {
        ...
        self.cellTextLabelFont = UIFont(name: "HelveticaNeue-Medium", size: 17)
//        self.cellSelectionColor = UIColor(red: CGFloat(234/255.0), green: CGFloat(62/255.0), blue: CGFloat(104/255.0), alpha: 1.0)
        //        self.checkMarkImage = UIImage(contentsOfFile: checkMarkImagePath!)
        self.animationDuration = 0.5
        self.arrowImage = UIImage(contentsOfFile: arrowImagePath!)
        self.arrowPadding = 15
//        self.maskBackgroundColor = UIColor.darkGrayColor()
...
class BTTableView: UITableView, UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        cell.backgroundColor = UIColor(red: CGFloat(234/255.0), green: CGFloat(62/255.0), blue: CGFloat(104/255.0), alpha: 1.0)
        return cell
    }
    ...
    func tableView(tableView: UITableView, didDeselectRowAtIndexPath indexPath: NSIndexPath) {
        ...
        cell?.contentView.backgroundColor = UIColor(red: CGFloat(234/255.0), green: CGFloat(62/255.0), blue: CGFloat(104/255.0), alpha: 1.0)
    }
}
...
class BTTableViewCell: UITableViewCell {
    ...
    init(style: UITableViewCellStyle, reuseIdentifier: String?, configuration: BTConfiguration) {
        ...
        self.contentView.backgroundColor = UIColor(red: CGFloat(234/255.0), green: CGFloat(62/255.0), blue: CGFloat(104/255.0), alpha: 1.0)
